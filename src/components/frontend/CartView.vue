            ...
            <ul class="cart-list">
                <li class="cart-item">
                    <div class="cart-media">
                        <a href="#"><img src="@/assets/frontend/images/product/01.jpg" alt="product" /></a><button
                            class="cart-delete">
                ...
                <li class="cart-item">
                    <div class="cart-media">
                        <a href="#"><img src="@/assets/frontend/images/product/02.jpg" alt="product" /></a><button
                            class="cart-delete">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>
                ...
                <li class="cart-item">
                    <div class="cart-media">
                        <a href="#"><img src="@/assets/frontend/images/product/03.jpg" alt="product" /></a><button
                            class="cart-delete">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>
                ...
                <li class="cart-item">
                    <div class="cart-media">
                        <a href="#"><img src="@/assets/frontend/images/product/04.jpg" alt="product" /></a><button
                            class="cart-delete">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>
                ...
                <li class="cart-item">
                    <div class="cart-media">
                        <a href="#"><img src="@/assets/frontend/images/product/05.jpg" alt="product" /></a><button
                            class="cart-delete">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>
