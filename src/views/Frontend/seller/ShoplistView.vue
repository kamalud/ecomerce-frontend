<template>
  <div>
    <section
      ...
      style="background: url(@/assets/frontend/images/single-banner.jpg) no-repeat center"
    >
      <div class="container">
        <h2>Shop Page</h2>
      </div>
      ...
      <div class="container">
        <div class="row content-reverse">
          <div class="col-lg-3">
            ...
            <a href="#"><img src="@/assets/frontend/images/promo/shop/01.jpg" alt="promo" /></a>
          </div> -->
                ...
                <div class="product-card product-disable">
                  <div class="product-media">
                    ...
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/06.jpg" alt="product"
                    /></a>
                  </div>
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/13.png" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/12.png" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/03.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/09.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/07.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/04.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/02.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/01.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="@/assets/frontend/images/product/05.jpg" alt="product"
                    /></a>
                  </div>
                  <div class="product-content">
                    <h6 class="product-name">
